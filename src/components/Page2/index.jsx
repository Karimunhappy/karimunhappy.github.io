...
const Page2 = () => {
    return (
        <div className="w-screen bg-[#f9ebea] p-9 lg:px-24">
            ...
            <div className='w-full'>
                <div className='grid grid-cols-2' data-aos="fade-up">
                    ...
                    <p>Kami menawarkan berbagai paket wisata menarik yang dirancang untuk memberikan pengalaman tak terlupakan.
                        ...
                        rasakan keajaiban Karimunjawa!</p>
                </div>
