...
const Paket3D2N = () => {
    return (
        <div className="bg-white py-44 flex flex-col items-center">
            ...
            <h2 className="text-center px-10 md:px-28 pb-20">Paket dengan durasi paling banyak diminati. Dengan paket ini anda mempunyai waktu cukup mengunjungi beberapa destinasi unggulan.</h2>
            <h2>Paket Siginjai</h2>
                ...
                <Table striped bordered hover>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Kamar Mandi Luar, Fan</td>
                            <td>800k</td>
                            <td>reservasi</td>
                        </tr>
                        <tr>
                            <td>HOMESTAY AC</td>
                            <td>Full AC, Kamar Mandi dalam</td>
                            <td>1,065k</td>
                            <td>reservasi</td>
                        </tr>
                        <tr>
