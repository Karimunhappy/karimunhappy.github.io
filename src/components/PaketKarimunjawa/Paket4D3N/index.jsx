...
const Paket4D3N = () => {
    ...
    return (
        <div className="bg-white py-44 flex flex-col items-center">
            ...
            ></div>
            <h1 className="-mt-96 text-white text-5xl">{t('content.packageTitle4D3N')}</h1>
            <div className="bg-[#2db0f4] h-[3px] w-32 my-3"></div>
            <h3 className="text-center px-10 md:px-28 py-16 text-white">{t('content.packageSubtitle4D3N')}</h3>
