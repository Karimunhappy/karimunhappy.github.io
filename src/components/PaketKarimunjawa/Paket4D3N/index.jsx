...
const Paket4D3N = () => {
    return (
        <div className="bg-white py-44 flex flex-col items-center">
            ...
            <h2 className="text-center px-10 md:px-28 pb-20">Paket paling ideal untuk diambil, bisa mengunjungi lebih banyak lagi destinasi, waktu kegiatan tidak terlalu padat.</h2>
